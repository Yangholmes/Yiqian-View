...
export default {
    ...
    methods: {
        ...
        onStart(e) {
            ...
            document.body.addEventListener('touchmove', this.onMove, false);
        ...
        onEnd(e) {
            ...
            document.body.removeEventListener('touchmove', this.onMove, false);
            document.body.removeEventListener('touchend', this.onEnd, false);
        }
    }
};
</script>
